...
class _RenderSliverStickyHeader extends RenderSliver with RenderObjectWithChildMixin<RenderBox>, RenderSliverHelpers {
  ...
  void layoutChild(
    ...
    if (_needsUpdateChild) {
      invokeLayoutCallback<SliverConstraints>((final SliverConstraints constraints) {
